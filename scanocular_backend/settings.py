"""
Django settings for scanocular_backend project.
...
SECRET_KEY = "django-insecure-m4yg)jxslp$!_u((+b$asc9t&v!hs8lnxpi(a0v_fu!d)n9599"
...
AUTHENTICATION_BACKENDS = [
    "users.backends.EmailBackend",  # Replace with the actual path
